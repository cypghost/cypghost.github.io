...
import "./contact.css";
import { HiOutlineMail, HiOutlinePhone, HiOutlineArrowSmRight } from "react-icons/hi"
...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_nmkf4px', 'template_s9z63sq', form.current, 'mtprW4XbnUtFpmAPQ')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">birukmesfin246@gmail.com</span>
                        
                        <a href="mailto:birukmesfin246@gmail.com" className="contact__button">
                            Write Me{" "} 
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">+251 98-998-4735</span>
                        
                        <a href="tel:+251989984735" className="contact__button">
                            Call Me{" "} 
                            <HiOutlineArrowSmRight className="contact__button-icon" />
                        </a>
                    </div>
